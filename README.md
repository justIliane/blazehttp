...
- **[Claude Code](https://claude.ai/claude-code) (Anthropic)** — This project was entirely generated by Claude Code (Opus 4.6) in ~7 hours, guided by detailed phase-by-phase prompts. See [doc/DEVELOPMENT.md](doc/DEVELOPMENT.md) for the full process.

## 📈 Development History

BlazeHTTP was built in 15 phases over ~7 hours by Claude Code (Opus 4.6):
